...
int main(int argc, char **argv) {
    ...
    uint32_t no_of_conns = 0, cwnd = 5, no_of_nodes = DEFAULT_NODES,flowsize=Packet::data_packet_size()*50;
    ...
    uint32_t src_count=0, total_new=0, total_acked=0, total_nacked=0, total_bounced=0;
    //uint32_t total_rtx=0;
