...
int main(int argc, char **argv) {
    ...
    TcpSinkLoggerSampling sinkLogger = TcpSinkLoggerSampling(timeFromMs(0.1), eventlist);
    ...
    DragonFlyTopology* top = new DragonFlyTopology(no_of_nodes, queuesize, &logfile,&eventlist,RANDOM);
